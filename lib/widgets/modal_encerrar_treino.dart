...
class _ModalEncerrarTreinoDialogState extends State<ModalEncerrarTreinoDialog> {
  ...
  void initState() {
    ...
    _duracaoSegundos = widget.controller.duracaoTreinoSegundos;
    _descansoTotalSegundos = widget.controller.descansoTotalSegundos;
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Tempos da Sessão (Duração e Descanso com Edição)
              const Text(
